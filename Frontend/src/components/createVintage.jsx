...
export default function CreateVintage({
  ...
  const handleSubmit = () => {
    if (!newVintage.label.trim()) {
      toast.error("Le nom de la cuvée est requis.");
      return;
    }
    if (nameError) {
    ...
    if (Object.keys(quantityErrors).length > 0) {
      toast.error("Corrige les erreurs de quantités avant de continuer.");
      return;
    }
